test work based on nitrogen

Put this project in the folder with nitrogen project

To start server open project folder and type in console:
...
Further original nitrogen readme.
